...
class VpnLibsConan(ConanFile):
    ...
    def requirements(self):
        self.requires("dns-libs/2.6.2@adguard_team/native_libs_common", transitive_headers=True)
        self.requires("native_libs_common/7.0.23@adguard_team/native_libs_common", force=True, transitive_headers=True)
